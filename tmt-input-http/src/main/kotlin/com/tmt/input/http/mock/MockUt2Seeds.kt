...
object MockUt2Seeds {
    ...
    private val GROUPS =
        listOf(
            ...
            Ut2Group("법카로 회식하기 좋은 고깃집", "구디 회식은 여기서 정합니다", "cat_meat", "region_guro", PERSONA_OFFICE),
            Ut2Group("점심때 회사 사람들이랑 맛있는거 먹고싶을 때 가는 맛집", "구디 점심 원정대", "cat_korean", "region_guro", PERSONA_OFFICE),
            Ut2Group("나만 알고 싶은 분위기 좋은 데이트 장소", "소개하기 아까운 곳만 모음", "cat_bar", "region_seoul_all", PERSONA_EXPLORER),
            Ut2Group("강서구에도 맛집 많다 무시하지마라", "강서구 맛집 부심", "cat_korean", "region_gangseo", PERSONA_EXPLORER),
            Ut2Group("잠실에서 놀면 맨날 여기만 가는 맛집 모음", "잠실 단골집만 모았습니다", "cat_meat", "region_songpa", PERSONA_JAMSIL),
            Ut2Group(
                "강남에서 몇 안되는 체인점 아닌 내 맛집 모임",
                "강남에서 찾은 진짜 단골집",
                "cat_japanese",
                "region_gangnam",
                PERSONA_JAMSIL,
